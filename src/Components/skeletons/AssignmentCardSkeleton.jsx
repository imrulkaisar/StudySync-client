const AssignmentCardSkeleton = () => {
  return (
    <div
      role="status"
      className="p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 flex flex-col lg:flex-row gap-5"
    >
      <div className="flex items-center justify-center h-32 mb-4 bg-gray-300 rounded w-full lg:w-56">
        <svg
