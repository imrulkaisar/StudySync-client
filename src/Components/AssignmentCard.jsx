...
const AssignmentCard = () => {
  ...
  return (
    <article className="flex rounded-lg overflow-hidden w-full relative bg-gray-50">
      <Link to={detailsLink}>
        <img
          className="w-56 aspect-video object-cover"
          src="https://th.bing.com/th/id/OIP.C3YgRLy7VOqgL3tAbyWEQQAAAA?pid=ImgDet&rs=1"
          alt=""
        />
      </Link>
      <span className="absolute gradient-bg py-1 px-5 rounded-br-lg text-white">
        Easy
      </span>
      <div className="p-5 border flex-grow rounded-tr-lg rounded-br-lg">
        ...
        <div className="mt-5 flex gap-5 justify-between">
          <Link
            to={detailsLink}
            className="flex gap-2 items-center uppercase text-xs tracking-wider"
          >
